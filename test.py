...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', type=str, default='./testdata/train/in/')
    parser.add_argument('--result_dir', type=str, default='./Test1/result/')
    parser.add_argument('--resume_state', type=str, default='./WeatherFormer/pre_trained_models/WeatherFormer_allweather.pth')
